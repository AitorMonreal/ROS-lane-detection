    ...
    def robot_position(self):
        ...
        if exists:
            ...
            if len(self.lines_above_robot_a) > 0:
                ...
                self.line_above_mean.draw(color_img, grid_trimmed.shape[1], (255,0,0))
            ...
            if len(self.lines_below_robot_b) > 0:
                ...
                self.line_below_mean.draw(color_img, grid_trimmed.shape[1], (0,255,0))
