...
class LaneKeeping():
    ...
    def grid_cb(self, msg):
        ...
        prev_width = grid_flipped.shape[0]

        grid_trimmed = grid_flipped[robot_y_centre-(lane_width/2):robot_y_centre+(lane_width/2), :]
        ...
        self.draw_origin(0, 2, color_img, int(origin_x), int(origin_y))
